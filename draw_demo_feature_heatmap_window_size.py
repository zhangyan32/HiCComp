...
CNN_map_4 = np.load(path + '/K562vsGM12878_chr18_size100_step10_CNN_important_samples.npy')
CNN_map_8 = np.load(path + '/K562vsGM12878_chr18_size100_step10_CNN_important_samples.npy')
CNN_map_16 = np.load(path + '/K562vsGM12878_chr18_size100_step10_CNN_important_samples.npy')
start = 2000   
end = 4000
'''
print (Pixel_map > 0)
